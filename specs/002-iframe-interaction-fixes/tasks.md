...
- [ ] T004 Implement list_frames tool that enumerates page.frames with attributes (name, src, aria-label, title, accessible) in src/browser_agent/tools/frames.py
- [ ] T005 [P] Implement _prioritize_frames() utility for semantic-first frame search order (FR-025) in src/browser_agent/tools/frames.py
...
- [ ] T009 [P] [US1] Integration test for iframe search flow in tests/integration/test_iframes.py::test_search_in_iframe
...
- [ ] T011 [US1] Add optional frame_selector parameter to _find_element_by_description() in src/browser_agent/tools/interactions.py
- [ ] T012 [US1] Implement _find_element_in_all_frames() utility that searches main frame then iframes (FR-004, FR-010) in src/browser_agent/tools/interactions.py
- [ ] T013 [US1] Enhance type_text tool with frame parameter and auto-search (FR-014) in src/browser_agent/tools/interactions.py
- [ ] T014 [US1] Add frame_context to ToolResult.data for all successful interactions (FR-011) in src/browser_agent/tools/interactions.py
