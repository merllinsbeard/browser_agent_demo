...
- [x] T023 [P] [US3] Unit test for frame metadata markers in tests/unit/test_frame_tools.py::test_frame_metadata_format
...
- [x] T038 Run full test suite and verify >80% iframe coverage (SC-007)
- [x] T039 Verify all existing tests still pass (SC-006 backward compatibility)
